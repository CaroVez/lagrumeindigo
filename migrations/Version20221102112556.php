 ...
 */
final class Version20221102112556 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contract (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', franchise_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', gym_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', send_newsletter TINYINT(1) NOT NULL, team_planning TINYINT(1) NOT NULL, sell_drinks TINYINT(1) NOT NULL, promotion TINYINT(1) NOT NULL, payment_schedules TINYINT(1) NOT NULL, statistics TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_E98F2859523CAB89 (franchise_id), UNIQUE INDEX UNIQ_E98F2859BD2F03 (gym_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE franchise (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', user_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', name VARCHAR(60) NOT NULL, active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_66F6CE2AA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE gym (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', user_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', name VARCHAR(60) NOT NULL, active TINYINT(1) NOT NULL, address LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_7F27DBEDA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
